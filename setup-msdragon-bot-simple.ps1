# Simple setup script for @MsDragonBot
# Usage: .\setup-msdragon-bot-simple.ps1 "YOUR_BOT_TOKEN"
...
try {
    ...
    Write-Host "   [WARNING] Could not delete old webhook" -ForegroundColor Yellow
}
